...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{graphics/2015-08-26_11-24-21_faui1-246_visits}
\caption[Number of successful peer visits]{Number of successful peer visits. Outgoing peers are a combination of peers form tracker servers and the DHT network.}
\label{visits}
\end{figure}

\paragraph{peer\_revisit\_delay}
Peers were contacted for their download progress every five minutes. The delay should be as small as possible, to consider peers who stop seeding a torrent instantly after they finished downloading it. Five minutes caused no problem with system resources and peers did not start to block connections due to the frequent contacts.

[Figure \ref{visits} shows the number of visits has no jumps indicating a maximum number of visits]
