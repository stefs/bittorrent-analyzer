...
\item The success rate of confirming downloads for unique peers is below \numprint[\%]{2}. Reasons are seeding peers, which are part of the torrent swarm, but do not download any more. Besides this, wrong peer data and other problems when counting confirmed downloads reduce this value.
