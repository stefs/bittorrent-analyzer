...
In order to support the validity of the test results, some statistics were logged to the database every five minutes. These are shown in figure \ref{workload}. Graphs of a low thread workload and the short length of the peer queue make clear, that the number of \numprint{1024} worker threads was enough. The number of used evaluator threads did actually not surpass \numprint{500}. The *low number of recorded active threads in the first hours could be explained by a coincidence caused by the low sample rate, but is not conclusive. The length of the visited queue is almost always zero, which proves that the database was no bottleneck. A maximum of \numprint[MB]{520} RAM is used, which is way below the available \numprint[GB]{2}. The Unix load-average is below the \numprint{2} mark for two processor cores.
...
\begin{itemize}
%The 4 most popular torrents below \numprint[GB]{1}
...
\begin{enumerate}
\item The number of unique peers received from all sources is by factor \numprint{0}* above the tracker reported download numbers.
\item For only \numprint[\%]{0}* of tracker reported downloads and for \numprint[\%]{0}* of unique peers a download could be confirmed.
\end{enumerate}
...
\includegraphics[width=\textwidth, page=2]{../evaluation/y/2015-08-30_20-combined_download_confirmed_scrape}
(b) Confirmed ratio regarding reported downloads by torrent size.
\includegraphics[width=\textwidth, page=1]{../evaluation/y/2015-08-30_20-combined_download_confirmed_scrape}
...
\includegraphics[width=\textwidth, page=2]{../evaluation/y/2015-08-30_20-combined_download_confirmed_unique}
(b) Confirmed ratio regarding unique peers by torrent size.
\includegraphics[width=\textwidth, page=1]{../evaluation/y/2015-08-30_20-combined_download_confirmed_unique}
...
\item The success rate of confirming downloads for unique peers is below \numprint[\%]{2}. An important reasons for this are seeding peers, which are part of the torrent swarm, but do not download data any more. Besides this, incorrect peer data and other problems of counting confirmed downloads reduce this value.
\item Success rate is lowest for torrents above \numprint[GB]{30}. Either, the tracker reported download numbers are disproportional high for these torrents, or peers did actually not download these torrents after announcing their address data to trackers and the DHT network
\end{enumerate}

\begin{figure}
\centering
\includegraphics[width=\textwidth]{../evaluation/y/2015-08-30_20-combined_download_set}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{../evaluation/y/2015-08-30_20-combined_speed_plot}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{../evaluation/y/2015-08-30_20-combined_speed_map}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth, page=2]{../result/2015-08-27_21-03-31_faui1-246_visits}
