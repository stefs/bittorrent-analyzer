...
Lists and dictionaries are composite data types, which can contain any other bencoded values, which allows nested dictionaries or lists. Note that only strings can be used as dictionary keys.
