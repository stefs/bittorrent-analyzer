...
\item The success rate of confirming downloads for unique peers is below \numprint[\%]{2}. An important reason for this are seeding peers, which are part of the torrent swarm, but do not download any more. Besides this, outdated peer data reduces this value.
