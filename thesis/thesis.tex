...
A big problem is the high drop-off rate of \numprint[\%]{85} after the first active visit (see figure \ref{visits}). The fact that a minimum of two successful evaluations is mandatory to decide whether a peer crossed a threshold, makes this value important and problematic.
...
[The success rates of confirming downloads are very low.]

[other tracker scrapes not included]

[other method: responding peers]

[other method: use progress without threshold crossing]
