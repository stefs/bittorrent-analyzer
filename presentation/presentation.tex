...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{frame}[fragile]{Bencoding und Torrent-Datei}
		\begin{center}
			\begin{tabular}{lll}
				\toprule
				Typ & Bencoding & Beispiel \\
				\midrule
				String & \texttt{<length>:<string>} & \texttt{3:abc} = \texttt{"abc"} \\
				Integer & \texttt{i<integer>e} & \texttt{i23e} = \texttt{23} \\
				List & \texttt{l<val1>...e} & \texttt{l3:abci23ee} = \texttt{["abc", 23]} \\
				Dictionary & \texttt{d<key1><val1>...e} & \texttt{d3:abci23ee} = \texttt{\{"abc": 23\}} \\
				\bottomrule
			\end{tabular}
		\end{center}
